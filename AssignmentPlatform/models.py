...
class AssignmentScore (models.Model) :
    ...
    q11_score       = models.DecimalField("نمره سوال 11",max_digits=4, decimal_places=2, blank=True, null=True, default=None)
    q12_score       = models.DecimalField("نمره سوال 12",max_digits=4, decimal_places=2, blank=True, null=True, default=None)
    q13_score       = models.DecimalField("نمره سوال 13",max_digits=4, decimal_places=2, blank=True, null=True, default=None)
    q14_score       = models.DecimalField("نمره سوال 14",max_digits=4, decimal_places=2, blank=True, null=True, default=None)
    q15_score       = models.DecimalField("نمره سوال 15",max_digits=4, decimal_places=2, blank=True, null=True, default=None)
    q16_score       = models.DecimalField("نمره سوال 16",max_digits=4, decimal_places=2, blank=True, null=True, default=None)
    q17_score       = models.DecimalField("نمره سوال 17",max_digits=4, decimal_places=2, blank=True, null=True, default=None)
    q18_score       = models.DecimalField("نمره سوال 18",max_digits=4, decimal_places=2, blank=True, null=True, default=None)
    q19_score       = models.DecimalField("نمره سوال 19",max_digits=4, decimal_places=2, blank=True, null=True, default=None)
    q20_score       = models.DecimalField("نمره سوال 20",max_digits=4, decimal_places=2, blank=True, null=True, default=None)
